...
const createDepartment = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield (yield academicDepartment_model_1.AcademicDepartment.create(payload)).populate('academicFaculty');
    return result;
});
const getAllDepartment = (filters, paginationOptins) => __awaiter(void 0, void 0, void 0, function* () {
